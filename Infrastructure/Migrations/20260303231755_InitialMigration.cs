    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdenProductos", x => new { x.OrdenId, x.ProductoId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Laptop Pro", 1500.00m },
                    { 2, "Mouse Gamer", 25.50m },
                    { 3, "Monitor OLED 4K", 400.00m },
                    { 4, "Teclado Mecánico", 150.00m },
                    { 5, "Silla Ergonómica", 500.00m }
                });
